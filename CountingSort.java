...
public class CountingSort {
    ...
    /**
     * Improved CountingSort which supports Integer[] array, and allows
     * user to select the range of values. Where k is the maximum value,
     * and the range of input array is between 0 to k, [0,k].
     * @param arr   Input Array
     * @param k     The max range of values
     * @return      The final sorted array of the input
     */
    public static Integer[] betterCountingSort(Integer[] arr, int k){
        // Initialize countArray with k+1 possible elements, including 0 and k
        Integer[] countArray = new Integer[k+1]; 
    ...
    public static void main(String[] args){
        ...
        Integer[] example = { 60, 40, 30, 20, 10, 40, 30, 60, 60, 20, 40, 30, 40,
            70, 70, 90, 80, 40};
        ...
        Integer[] newInput = list.stream().toArray(Integer[]::new);
        k = 90;
        
        System.out.println("Before Sorting"); 
        System.out.println(Arrays.toString(newInput)); 
        betterCountingSort(newInput, k); 
        System.out.println("After Sorting");
        System.out.println(Arrays.toString(newInput));
    }
}
